...
var euWorld: number = (Europa / Welt) * 100;
var naWorld: number = (NorthAmerica / Welt) * 100;
var asWorld: number = (Asia / Welt) * 100;
var saWorld: number = (SouthAmerica / Welt) * 100;
var afWorld: number = (Africa / Welt) * 100;
var auWorld: number = (Australia / Welt) * 100;

var euRate: number = (euDif / Europa) * 100;
var naRate: number = (naDif / NorthAmerica) * 100;
var asRate: number = (asDif / Asia) * 100;
var saRate: number = (saDif / SouthAmerica) * 100;
var afRate: number = (afDif / Africa) * 100;
var auRate: number = (auDif / Australia) * 100;
